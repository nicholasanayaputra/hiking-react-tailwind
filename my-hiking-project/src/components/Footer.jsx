  ...
  return (
    <div className='w-full mt-24 bg-gray-900 text-gray-300 py-2 px-2'>
        <div className='max-w-[1400px] mx-auto grid grid-cols-2 md:grid-cols-6 border-b-2 border-gray-600 py-8 px-4'>
            ...
            <div>
                    <h6 className='font-bold uppercase pt-2'>Compant</h6>
                <ul>
                    <li className='py-1'>About</li>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li  className='py-1'>Conditios</li>
                </ul>
            </div>
            <div className='col-span-2 py-8 md:pt-2'>
                ...
                <form className='flex flex-col sm:flex-row'>
                    <input className='w-full p-2 mr-4 r-4 rounded-md mb-4' type="email" placeholder='Enter email..' />
                    <button className='p-2 mb-4 rounded-md hover:bg-gray-800'>Subscribe</button>
                </form>
            </div>
        </div>
        <div className='flex flex-col max-w-[1400px] px-2 py-4 mx-auto justify-between sm:flex-row text-center text-gray-500'>
            <p className='py-4'>2022 Experiences, LLC, All right reserver</p>
